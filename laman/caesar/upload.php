        ...
        <div class="row">
            <div class="col-lg-8 mx-auto px-5 my-5">
                <form method='post' action='#hasil' class="form form-group-lg" enctype="multipart/form-data">
                    ...
                    <div class="mt-4 p-3 w-25 bg-dark border border-danger text-warning">
                        <span>Masukkan Jumlah Key! </span>
                    </div>
                    <input placeholder="Masukkan Key...." name="key" class="form-control form-control-lg w-25" >
            ...
            $input = "INSERT INTO caesar(id, metode, waktu, tgl, file_en, kunci) 
            VALUES ('','Caesar Enkripsi','$jam_sekarang', '$tanggal', '$file1','$key')";
            ...
            $tanggal = date("Y-m-d");
            $konek = mysqli_connect('127.0.0.1', 'root', '', 'kripto');
            $input = "INSERT INTO caesar2(id, metode, waktu, tgl, file_de, kunci) 
             VALUES ('','Caesar Deskripsi','$jam_sekarang', '$tanggal', '$file1','$key')";
            mysqli_query($konek, $input);
